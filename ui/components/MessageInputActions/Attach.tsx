...
const Attach = ({
  ...
  return loading ? (
            ...
            <div className="flex flex-row items-center justify-between px-3 py-2">
              ...
              <div className="flex flex-row items-center space-x-4">
                ...
                >
                  ...
                  />
                  <Plus size={18} />
                  <p className="text-xs">{t("upload.add")}</p>
                </button>
                <button
                  onClick={() => {
                    setFiles([]);
                ...
                >
                  <Trash size={14} />
                  <p className="text-xs">{t("upload.clear")}</p>
                </button>
              </div>
            </div>
    ...
    >
      ...
      {showText && <p className="text-xs font-medium pl-[1px]">{t("chat.attach")}</p>}
    </button>
  );
};
